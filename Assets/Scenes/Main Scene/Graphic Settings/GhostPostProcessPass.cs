...
[System.Serializable]
public class GhostPostProcessPass : ScriptableRenderPass {
  ...
  public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
    ...
    var material = GhostPostProcessingMaterialInstance.GetMaterial;
    if (material == null) {
    ...
    //---Custom effect here---
    var customEffect = stack.GetComponent<GhostPostProcessEffect>();
